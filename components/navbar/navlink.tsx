...
const NavLink = () => {
  ...
  return (
   <>
        <button onClick={()=> setOpen(!open)} className='inline-flex items-center p-2 
        justify-center text-sm text-gray-500 rounded-md lg:hidden hover:bg-gray-100'
        >
        ...
        <div className={clsx("w-full md:block md:w-auto", {
            ...
            md:bg-white">
                ...
                <li className="pt-2 md:pt-0">
                    ...
                    hover:bg-orange-500 rounded-sm"
                    >
                        Sign In
                    </Link>
                </li>
